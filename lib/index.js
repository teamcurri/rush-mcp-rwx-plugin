...
const ValidateWorkflowTool_1 = require("./tools/ValidateWorkflowTool");
const GetRunResultsTool_1 = require("./tools/GetRunResultsTool");
const GetArtifactsTool_1 = require("./tools/GetArtifactsTool");
class RwxPlugin {
    constructor(session) {
    ...
    async onInitializeAsync() {
        try {
            ...
            this.session.registerTool({ toolName: 'validate_workflow' }, new ValidateWorkflowTool_1.ValidateWorkflowTool(this));
            this.session.registerTool({ toolName: 'get_run_results' }, new GetRunResultsTool_1.GetRunResultsTool(this));
            this.session.registerTool({ toolName: 'get_artifacts' }, new GetArtifactsTool_1.GetArtifactsTool(this));
